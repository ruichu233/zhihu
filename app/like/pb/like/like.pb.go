...
func (x *GetPostLikeCountResponse) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *GetPostLikersResponse) GetUserIds() []string {
	if x != nil {
		return x.UserIds
	}
	return nil
...
func (x *GetUserTotalLikesRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *GetUserTotalLikesResponse) GetTotalLikes() int32 {
	if x != nil {
		return x.TotalLikes
	}
	return 0
...
var file_like_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x2e, 0x0a, 0x13,
	...
	0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x3c, 0x0a, 0x19,
	...
	0x61, 0x6c, 0x5f, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a,
