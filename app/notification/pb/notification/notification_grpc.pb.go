...
func (c *notificationServiceClient) GetNotifications(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*NotificationResponse, error) {
...
type NotificationServiceServer interface {
	GetNotifications(context.Context, *NotificationRequest) (*NotificationResponse, error)
...
func (UnimplementedNotificationServiceServer) GetNotifications(context.Context, *NotificationRequest) (*NotificationResponse, error) {
...
func _NotificationService_GetNotifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetNotifications(ctx, req.(*NotificationRequest))
	}
